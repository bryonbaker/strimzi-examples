...
This repo provides a short example of how to create a simple kafka cluster on OpenSHift using Strimzi. The topic is only accessible from within the cluster and is unauthenticated. This gist will be refined with more detail related to securing the cluster and topic over time.
